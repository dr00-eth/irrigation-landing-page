  ...
  <div>
    ...
    <Divider speed={0.1} offset={offset} factor={factor}>
      <UpDown>
        ...
        <Svg icon="logo" hiddenMobile width={24} color="icon_brightest" left="17%" top="60%" />
      </UpDown>
      <UpDownWide>
        <Svg icon="arrowUp" hiddenMobile width={16} color="icon_green" left="20%" top="90%" />
        <Svg icon="logo" width={12} stroke color="icon_brightest" left="90%" top="30%" />
        <Svg icon="logo" width={16} color="icon_yellow" left="70%" top="90%" />
